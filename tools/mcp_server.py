...
Requires FaultLine API running (default: http://localhost:8000, configurable via
FAULTLINE_API_URL env var or --api-url argument).

Usage:
  python mcp_server.py
  python mcp_server.py --api-url http://192.0.2.10:8000
...
if __name__ == "__main__":
    ...
    if args.transport == "http":
        ...
        print(f"[faultline-mcp] FaultLine API: {os.environ.get('FAULTLINE_API_URL', 'http://localhost:8000')}", file=sys.stderr)
